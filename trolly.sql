...
--
-- Host: localhost
-- Generation Time: May 19, 2020 at 07:34 PM
...
INSERT INTO `admins` (`id`, `username`, `password`, `firstname`, `surname`, `email`, `dob`) VALUES
(1, 'obi', '$2y$10$zNfhydLjSz7k2.p4LjWsg.HR0O5aGfV.A.zbQscaSxHcOZjFPo9tG', 'Onyeka', 'Chinyelu', 'onyeka.chidinma@gmail.com', '2006-03-25'),
(2, 'Admin', '$2y$10$bC72TpiNackMOYiEg5FsNuXwIEHWv6Qa8hU0Vej8NuAi9kqT6b6Bi', 'Admin', 'Admin', 'Admin@admin.com', '1996-08-26'),
(3, 'AdminUser', '$2y$10$jovGANV5c40JJPpXjJkHW.ebFoCXrojfeGs7AZnKihDninoLSEUui', 'Admin', 'Admin', 'Admin@admin.com', '1996-08-26');
...
INSERT INTO `local_governments` (`id`, `state_id`, `names`) VALUES
(1, 1, 'Aba North'),
(2, 1, 'Aba South'),
(3, 1, 'Arochukwu'),
(4, 1, 'Bende'),
...
CREATE TABLE `orderss` (
  ...
  `emails` varchar(50) NOT NULL,
  `states` varchar(50) NOT NULL,
  `local_governments` varchar(50) NOT NULL,
...
INSERT INTO `testimonial` (`id`, `images`, `testimony`) VALUES
(1, '<iframe width=\"100%\" height=\"250px\" src=\"https://www.youtube.com/embed/Osn4H2BCsx4\" frameborder=\"0\" allow=\"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>', 'Because of the ability of the product to stimulate the human body cells to regenerate itself and produce new cells. It can manage over 134 diseases. skin conditions, ulcers, diabetes sores, stroke, brain injuries, low sperm count, baldness, blindness and many more'),
(2, '<iframe width=\"100%\" height=\"250px\" src=\"https://www.youtube.com/embed/m0SxLqMOY1o\" frameborder=\"0\" allow=\"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>', 'Genetic Defects — Even more promising is the potential to address genetic defects that are present from birth by restoring function and health with the introduction of normal healthy cells that do not have these defects.'),
(3, '<iframe width=\"100%\" height=\"250px\" src=\"https://www.youtube.com/embed/egbXaKGfrMo\" frameborder=\"0\" allow=\"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>', 'STC cures Fibroid, Ovarian cysts, appendicitis\r\nSuperlife’s mission is to promote health and wellness of members while working towards financial freedom for members. So partners are given product so that they can try and have their own first hand experience of it and be able to share their testimony as well.');
